...
SECRET_KEY = '%*m9fl+5d^=6=zvqjj(tyjexuqs%9m!5&+vain^i^64*$7(ujp'
...
INSTALLED_APPS = [
    ...
    'chatbot_webservice.apps.ChatbotWebserviceConfig',
    'rest_framework',
    'corsheaders',
]
...
DATABASES = {
    'default': {
        ...
        'PORT': 5432,
        'USER': 'svqeeujozvcufh',
        'PASSWORD': 'a1924ab5de0f955332a512def9af171c0084f979b89851a2c7b553886d8f6c43'
    }
}
